...
for n = 1:length(sub);
    ...
    clear nn
    clear reg
    reg = sortrows([design.combined.feed2(find(design.combined.feed2(:,5) == 1),14); design.combined.feed1(find(design.combined.feed1(:,5) == 1),14)],1);
    for nn = 1:length(reg);
        clear m
        for m = 1:3;
            clear x
    ...
    clear nn
    clear reg
    reg = sortrows([design.combined.feed2(find(design.combined.feed2(:,5) == 2),14); design.combined.feed1(find(design.combined.feed1(:,5) == 2),14)],1);
    for nn = 1:length(reg);
        clear m
        for m = 1:3;
            clear x
    ...
    clear nn
    clear reg
    reg = sortrows([design.combined.feed2(find(design.combined.feed2(:,5) == 3),14); design.combined.feed1(find(design.combined.feed1(:,5) == 3),14)],1);
    for nn = 1:length(reg);
        clear m
        for m = 1:3;
            clear x
